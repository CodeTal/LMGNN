...
def create_LMGNN_data(grounded_path, qafile_path, cpnet_graph_path, cpnet_vocab_path, output_sents_path, output_graphs_path):
...
if __name__ == '__main__':
    ...
    create_LMGNN_data(
        './data/csqa/grounded/dev.grounded.jsonl',
        './data/csqa/dev_rand_split.jsonl',
        './data/cpnet/conceptnet.en.unpruned.graph',
        './data/cpnet/concept.txt',
        './data/csqa/test_sents.jsonl',
        './data/csqa/sent_graphs_test.pt',
        # './tokenizer.model'
    )
